...
class VideoTrimmerActivity : UploadPluginBindingActivity<ActivityVideoTrimBinding>(),
    ...
    fun initUI() {
        ...
        mBinding.apply {
            ...
            trimmerView.setOnTrimVideoListener(this@VideoTrimmerActivity)
            trimmerView.initVideoByURI(Uri.parse(path))
            trimmerView.tv_reset.setOnClickListener { initUI() }
        }
    ...
    companion object {
        ...
        fun call(from: FragmentActivity, videoPath: String, videoName: String) {
            if (!TextUtils.isEmpty(videoPath)) {
                ...
                from.startActivityForResult(intent, VideoPicker.REQUEST_CODE_ITEM_CROP)
            }
        }
    }
}
