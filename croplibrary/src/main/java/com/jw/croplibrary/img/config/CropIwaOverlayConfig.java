...
import com.jw.croplibrary.img.shape.CropIwaRectShape;
import com.jw.croplibrary.img.shape.CropIwaShape;
import com.jw.croplibrary.img.util.ResUtil;
    ...
    public static CropIwaOverlayConfig createFromAttributes(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            try {
                ...
                c.setCropShape(ta.getInt(R.styleable.CropIwaView_ci_crop_shape, 0) == 0 ? new CropIwaRectShape(c) : new CropIwaOvalShape(c));
