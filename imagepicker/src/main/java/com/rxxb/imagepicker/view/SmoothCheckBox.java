...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        TypedArray ta = this.getContext().obtainStyledAttributes(attrs, styleable.SmoothCheckBox);
        int tickColor = ta.getColor(styleable.SmoothCheckBox_color_tick, -1);
        this.mAnimDuration = ta.getInt(styleable.SmoothCheckBox_duration, 300);
        this.mFloorColor = ta.getColor(styleable.SmoothCheckBox_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        this.mCheckedColor = ta.getColor(styleable.SmoothCheckBox_color_checked, COLOR_CHECKED);
        this.mUnCheckedColor = ta.getColor(styleable.SmoothCheckBox_color_unchecked, -1);
        this.mStrokeWidth = ta.getDimensionPixelSize(styleable.SmoothCheckBox_stroke_width, this.dp2px(this.getContext(), 0.0F));
        ta.recycle();
