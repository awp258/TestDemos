...
public class FolderPopUpWindow extends PopupWindow implements OnClickListener {
    ...
    public FolderPopUpWindow(Context context, BaseAdapter adapter) {
        super(context);
        final View view = View.inflate(context, layout.pop_folder, (ViewGroup)null);
        this.masker = view.findViewById(id.masker);
        this.masker.setOnClickListener(this);
        this.marginView = view.findViewById(id.margin);
        this.marginView.setOnClickListener(this);
        this.listView = (ListView)view.findViewById(id.listView);
