...
public class CropImageView extends AppCompatImageView {
    ...
    public CropImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, styleable.CropImageView);
        this.mMaskColor = a.getColor(styleable.CropImageView_cropMaskColor, this.mMaskColor);
        this.mBorderColor = a.getColor(styleable.CropImageView_cropBorderColor, this.mBorderColor);
        this.mBorderWidth = a.getDimensionPixelSize(styleable.CropImageView_cropBorderWidth, this.mBorderWidth);
        this.mFocusWidth = a.getDimensionPixelSize(styleable.CropImageView_cropFocusWidth, this.mFocusWidth);
        this.mFocusHeight = a.getDimensionPixelSize(styleable.CropImageView_cropFocusHeight, this.mFocusHeight);
        this.mDefaultStyleIndex = a.getInteger(styleable.CropImageView_cropStyle, this.mDefaultStyleIndex);
        this.mStyle = this.styles[this.mDefaultStyleIndex];
        a.recycle();
