...
import com.rxxb.imagepicker.crop.image.CropIwaBitmapManager.BitmapLoadListener;
    ...
    public void tryExecute(Context context) {
        if (!this.executed) {
            if (this.width != 0 && this.height != 0) {
                ...
                com.rxxb.imagepicker.crop.util.CropIwaLog.d("LoadBitmapCommand for %s delayed, wrong dimensions {width=%d, height=%d}", new Object[]{this.uri.toString(), this.width, this.height});
            }
        }
    }
}
