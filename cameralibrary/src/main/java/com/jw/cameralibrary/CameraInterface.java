...
import com.jw.cameralibrary.listener.ErrorListener;
import com.jw.cameralibrary.util.AngleUtil;
import com.jw.cameralibrary.util.CameraParamUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    private static Rect calculateTapArea(float x, float y, float coefficient, Context context) {
        ...
        int centerX = (int) (x / ThemeUtils.INSTANCE.getWindowWidth(context) * 2000 - 1000);
        int centerY = (int) (y / ThemeUtils.INSTANCE.getWindowHeight(context) * 2000 - 1000);
...
/*        if (DeviceUtil.isHuaWeiRongyao()) {
    ...
    public void stopRecord(boolean isShort, StopRecordCallback callback) {
        ...
        if (mediaRecorder != null) {
            ...
            if (isShort) {
                if (FileUtils.INSTANCE.deleteFile(videoFileAbsPath)) {
