...
import com.jw.cameralibrary.databinding.CameraViewBinding;
...
import com.jw.cameralibrary.state.CameraMachine;
...
//    private static final String TAG = "JCameraView";
    ...
    private Runnable timeRunnable = new Runnable() {
        ...
        public void run() {
            while (!isShouldInterrupt) {
                ...
                mBinding.setCurrentLength(length);
            }
        }
    };
    ...
    private void initView() {
        ...
        mCaptureLayout = mBinding.captureLayout;
        mCaptureLayout.setDuration(duration);
        mCaptureLayout.setIconSrc(iconLeft, iconRight);
        mFoucsView = mBinding.fouceView;
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void takeTypeChange(int takeType) {
                mBinding.setCurrentTakeType(takeType);
            }
        });
        //确认 取消
    ...
    public void resetState(int type) {
        switch (type) {
            case TYPE_VIDEO:
                stopVideo();    //停止播放
                //初始化VideoView
                FileUtils.INSTANCE.deleteFile(videoUrl);
                videoUrl = null;
