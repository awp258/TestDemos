package com.jw.uploadlibrary.videoupload.impl;
...
public class TVCClient {
    ...
    private String getCosIP(String uploadRegion) throws CosXmlClientException {
        PutObjectRequest putObjectRequest = new PutObjectRequest(cosBucket, cosCoverPath, uploadInfo.getCoverPath());
        final String cosHost = putObjectRequest.getHost(cosXmlServiceConfig, isOpenCosAcc);
